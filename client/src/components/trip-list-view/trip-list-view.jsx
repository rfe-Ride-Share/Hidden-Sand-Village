...
function TripListView() {
  ...
  console.log("🚀 ~ file: trip-list-view.jsx ~ line 45 ~ TripListView ~ pendingTrips", pendingTrips)
  console.log("🚀 ~ file: trip-list-view.jsx ~ line 47 ~ TripListView ~ upcomingTrips", upcomingTrips)
  console.log("🚀 ~ file: trip-list-view.jsx ~ line 49 ~ TripListView ~ pastTrips", pastTrips)
